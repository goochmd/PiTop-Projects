...
##Security System:
Uses the camera as motion detection, the led and buzzer as an alarm, and the potentiometer and button as a passcode to end the alarm, to create a basic security system.